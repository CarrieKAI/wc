 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.group19.easySql.easySql.impl.SqlProgramImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SqlProgramImpl extends MinimalEObjectImpl.Container implements SqlProgram
{
  ...
  {
    return EasySqlPackage.Literals.SQL_PROGRAM;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, EasySqlPackage.SQL_PROGRAM__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EasySqlPackage.SQL_PROGRAM__STATEMENTS:
